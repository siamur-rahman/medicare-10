...
const HeaderMain = () => {
   return (
      <main style={{ height: '750px' }} className=" header-container row d-flex justify-content-center align-items-center p-2 w-100">
         ...
         <div className="col-md-12 col-lg-4 d-flex justify-content-center align-items-center offset-md-1 mb-4 fw-bolder text-white">
